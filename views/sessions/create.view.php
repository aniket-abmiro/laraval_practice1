...
<h2 style="text-align: center; margin-bottom: 20px;">Login Form</h2>
  <form action="/login" method="POST" style="max-width: 400px; margin: 0 auto;">
    ...
    <input type="text" id="email" name="email" value = "<?= old('email') ?>" required style="width: 100%; padding: 10px; margin-bottom: 10px; border-radius: 4px; border: 1px solid #ccc;"><br><br>
    ...
    <input type="submit" value="Login" style="background-color: #4CAF50; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer;">
  </form>
</main>
